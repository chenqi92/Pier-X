...
pub const SIZE_H1: Pixels = px(24.0);
pub const SIZE_H2: Pixels = px(20.0);
pub const SIZE_H3: Pixels = px(16.0);
pub const SIZE_BODY_LARGE: Pixels = px(14.0);
pub const SIZE_BODY: Pixels = px(13.0);
pub const SIZE_UI_LABEL: Pixels = px(13.0);
pub const SIZE_CAPTION: Pixels = px(12.0);
pub const SIZE_SMALL: Pixels = px(11.0);
pub const SIZE_MONO_CODE: Pixels = px(13.0);
pub const SIZE_MONO_SMALL: Pixels = px(12.0);
