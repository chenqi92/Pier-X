    ...
    <div className="panel-scroll">
      <section className="panel-section">
        ...
        <div className="form-stack">
          ...
          <div className="field-grid">
            <label className="field-stack"><span className="field-label">{t("Database")}</span><input className="field-input" onChange={(e) => setDbName(e.currentTarget.value)} value={dbName} /></label>
            <label className="field-stack"><span className="field-label">{t("Schema")}</span><input className="field-input" onChange={(e) => setSchema(e.currentTarget.value)} value={schema} /></label>
          </div>
