export const zhExtra: Record<string, string> = {
  ...
  Refresh: "刷新",
  Server: "服务器",
  "Server + Agent": "服务器 + Agent",
  "Not installed": "未安装",
  "Waiting for an SSH connection": "等待 SSH 连接",
  "NanoLink manages a remote host over SSH.": "NanoLink 通过 SSH 管理远程主机。",
  "NanoLink not installed": "未安装 NanoLink",
  "Install the agent to report this host's metrics to a NanoLink server.":
    "安装 Agent，将本机指标上报到 NanoLink 服务器。",
  ...
  "System admin": "系统管理",
  "Use TLS to the server": "与服务器之间使用 TLS",
  "Report hostname (optional)": "上报主机名（可选）",
  "system hostname": "系统主机名",
  "Install agent": "安装 Agent",
  "Installing…": "安装中…",
  "NanoLink agent installed.": "NanoLink Agent 已安装。",
  "This host needs a sudo password — set it in another panel and retry.":
    "该主机需要 sudo 密码 —— 请在其他面板设置后重试。",
  "Install failed.": "安装失败。",
  ...
  "Add server": "添加服务器",
  "No status output.": "无状态输出。",
  Restart: "重启",
  "Server running": "服务器运行中",
  "Server stopped": "服务器已停止",
  "This server requires login to read its dashboard.": "该服务器需要登录才能读取仪表盘。",
  "Logging in…": "登录中…",
  "Log in": "登录",
  Agents: "Agent 数",
  "Avg CPU": "平均 CPU",
  ...
  "No agents connected.": "暂无已连接的 Agent。",
  OS: "系统",
  "Remove server": "移除服务器",
  // NanoLink server: add machine (B) + command dispatch (C)
  "Add a monitored machine": "添加被监控机",
  Hide: "收起",
  "Generate config": "生成配置",
  "Generates an agent config + one-line install command to run on the new host. Requires a server admin login.":
    "生成一份 agent 配置 + 一行安装命令,在新主机上运行即可接入。需要服务器管理员登录。",
  "This server's address (host:gRPC port)": "本服务器地址(host:gRPC 端口)",
  "Verify server TLS certificate": "校验服务器 TLS 证书",
  Token: "Token",
  Copy: "复制",
  "Linux / macOS install": "Linux / macOS 安装",
  "Windows install": "Windows 安装",
  "Agent config (YAML)": "Agent 配置(YAML)",
  "Send command": "发送命令",
  "List processes": "列出进程",
  "List services": "列出服务",
  "Health check": "健康检查",
  ...
  "service name": "服务名",
  "no TLS": "无 TLS",
  "TLS (no verify)": "TLS（不校验）",
  "Agent status output": "Agent 状态输出",
  "Last seen": "最后心跳",
  "Running…": "执行中…",
  Send: "发送",
  ...
  // Static i18n coverage sweep (AI, DB, SSH, Docker, Git, settings)
  " · row cap hit on: {tables}": " · 以下表达到行数上限：{tables}",
  "?": "?",
  "…": "…",
  "(current role)": "（当前角色）",
  "(no comment)": "（无注释）",
  "{n} more prompt waiting": "还有 {n} 个提示待处理",
  "{n} rows": "{n} 行",
  "{n} tables selected": "已选择 {n} 张表",
  "○ paused": "○ 已暂停",
  "● streaming": "● 流式输出中",
  "✓ Reached %s in %dms": "✓ 已连接 %s，用时 %dms",
  "✗ %s failed (%dms): %s": "✗ %s 失败（%dms）：%s",
  "2.x API token or 1.x password": "2.x API token 或 1.x 密码",
  "ACL user (optional)": "ACL 用户（可选）",
  Address: "地址",
  Ahead: "领先",
  "ALTER SYSTEM · pg_reload_conf()": "ALTER SYSTEM · pg_reload_conf()",
  "Auto-vacuum mode (0 / 1 / 2)": "自动 VACUUM 模式（0 / 1 / 2）",
  Behind: "落后",
  "Browse the local MySQL as the terminal's current user (socket auth, no DB account)":
    "以终端当前用户浏览本机 MySQL（socket 认证，无需数据库账号）",
  "Browse the local PostgreSQL as the postgres OS user (peer auth, no role password)":
    "以 postgres 系统用户浏览本机 PostgreSQL（peer 认证，无需角色密码）",
  "Bucket / DB": "Bucket / 数据库",
  "Bundled + user-supplied command packs feed the Tab completion popover. Use Import to add a pack JSON, drop importer output into the directory below and click Reload, or remove user packs from the table.":
    "内置和用户提供的命令包会供给 Tab 补全弹窗。使用导入添加 pack JSON，或把导入器输出放到下方目录后点击重新加载，也可以在表格中移除用户命令包。",
  "Cache size (pages or KiB)": "缓存大小（页数或 KiB）",
  Charset: "字符集",
  "Choose Claude Code or Codex in Settings → AI first":
    "请先在设置 → AI 中选择 Claude Code 或 Codex",
  "CLI approvals": "CLI 审批",
  "CLI binary": "CLI 二进制",
  "CLI mode": "CLI 模式",
  "Click to change type": "点击更改类型",
  "Click to edit": "点击编辑",
  "Click to edit · {hint}": "点击编辑 · {hint}",
  "Click to edit comment": "点击编辑注释",
  "Close native CLI": "关闭原生 CLI",
  Collation: "排序规则",
  Column: "列",
  Comment: "注释",
  "comment: {c}": "注释：{c}",
  "Connect as postgres (socket)": "以 postgres 连接（socket）",
  "Connect as terminal user (socket)": "以终端用户连接（socket）",
  "connection-scoped": "连接级",
  "Copy {n} names": "复制 {n} 个名称",
  "Copy failed": "复制失败",
  "Copy name": "复制名称",
  "Created database \"{name}\".": "已创建数据库 \"{name}\"。",
  "Database name is required.": "请输入数据库名称。",
  "Database text encoding": "数据库文本编码",
  Description: "描述",
  Detect: "检测",
  "Detecting…": "检测中…",
  "df -h": "df -h",
  ...
  Domain: "域",
  "Drives your installed, logged-in CLI as the backend — no API key, it reuses your own subscription login. Leave blank to find it on PATH, or Detect it. Runs tool-less (M1) by default; Pier-X keeps its own gated tools.":
    "使用你已安装且已登录的 CLI 作为后端 —— 无需 API key，会复用你自己的订阅登录。留空会在 PATH 中查找，也可以点击检测。默认以无工具（M1）模式运行；Pier-X 仍保留自己的受控工具。",
  "Drop {n} table(s)?": "删除 {n} 张表？",
  "Drop {n} tables…": "删除 {n} 张表…",
  "Drop database \"{db}\"?": "删除数据库 \"{db}\"？",
  "Drop database…": "删除数据库…",
  "Drop table…": "删除表…",
  "Dropped {n} table(s).": "已删除 {n} 张表。",
  "Dropped database \"{db}\".": "已删除数据库 \"{db}\"。",
  "Edit section args": "编辑区段参数",
  editable: "可编辑",
  Email: "邮箱",
  "End of history": "已到历史末尾",
  "Enforce foreign keys (0 / 1)": "强制外键（0 / 1）",
  "Executed {n} statement(s) from {file}.": "已从 {file} 执行 {n} 条语句。",
  "Export {n} tables…": "导出 {n} 张表…",
  "Export database…": "导出数据库…",
  "Export table…": "导出表…",
  "Exported {tables} table(s), {rows} row(s) → {file}{warn}":
    "已导出 {tables} 张表、{rows} 行 → {file}{warn}",
  Extra: "额外",
  Fingerprint: "指纹",
  "Fingerprint copied": "指纹已复制",
  "Follow terminal elevation": "跟随终端提权",
  "Gated agent (local, Pier-X approves)": "受控 Agent（本地，Pier-X 审批）",
  "Gated agent: the CLI runs its own tools on THIS machine, but Pier-X approves each one (L0–L3 cards, red-line blocks). Local tabs only (not over SSH). Opt-in.":
    "受控 Agent：CLI 会在这台机器上运行自己的工具，但每一步由 Pier-X 审批（L0-L3 卡片、红线阻断）。仅限本地标签页（不通过 SSH）。需主动启用。",
  "global scope": "全局作用域",
  "Host key changed — possible MITM": "主机密钥已变更 —— 可能存在中间人攻击",
  "Import command pack": "导入命令包",
  "Import failed": "导入失败",
  "Import SQL…": "导入 SQL…",
  "Internal schema cookie": "内部 schema cookie",
  "Journal mode (delete / wal / memory / …)": "日志模式（delete / wal / memory / …）",
  "Key type": "密钥类型",
  "Loading more…": "加载更多…",
  "Local & remote": "本地和远程",
  "Magic application ID": "Magic application ID",
  "Model backend (gated)": "模型后端（受控）",
  "Model backend (recommended): the CLI only answers; Pier-X keeps its own per-action approval for execution.":
    "模型后端（推荐）：CLI 只负责回答；Pier-X 继续按操作逐项审批执行。",
  "MySQL variables": "MySQL 变量",
  "name (e.g. ServerName or Directory)": "名称（例如 ServerName 或 Directory）",
  "Native agent (local, self-governs)": "原生 Agent（本地，自主管理）",
  "Native agent: the CLI runs its OWN tools on THIS machine and self-governs — Pier-X's per-action approval does NOT apply. Local tabs only (not over SSH). Opt-in.":
    "原生 Agent：CLI 会在这台机器上运行自己的工具并自行管理 —— Pier-X 的逐项审批不会生效。仅限本地标签页（不通过 SSH）。需主动启用。",
  "Native CLI is running": "原生 CLI 正在运行",
  "Native CLI sessions are local-only. Switch to a local tab to start one.":
    "原生 CLI 会话仅支持本地。请切换到本地标签页再启动。",
  "Native CLI sessions run on this local machine only; SSH tabs are disabled.":
    "原生 CLI 会话只在本机运行；SSH 标签页已禁用。",
  "Native CLI started. Its own approval model applies.":
    "原生 CLI 已启动。将使用它自己的审批模型。",
  "Native CLI terminal": "原生 CLI 终端",
  "New database": "新建数据库",
  "New database…": "新建数据库…",
  "No connection": "无连接",
  "No measurements.": "暂无测量数据。",
  "No pinned key for {host} yet. Verify the fingerprint with the server admin out of band before accepting — this is the moment that anchors every future connection.":
    "尚未为 {host} 固定主机密钥。接受前请通过带外方式向服务器管理员核对指纹 —— 这一步会锚定之后的每次连接。",
  "No rows in this table.": "此表没有行。",
  "No settings available.": "没有可用设置。",
  "No settings match the filter.": "没有匹配筛选条件的设置。",
  "No SQL statements found in the file.": "文件中没有 SQL 语句。",
  "No tables to export in {db}.": "{db} 中没有可导出的表。",
  "No tables to export.": "没有可导出的表。",
  "No tables.": "没有表。",
  "Not connected to a Dameng instance": "未连接到达梦实例",
  "Not connected to a SQL Server instance": "未连接到 SQL Server 实例",
  "Not connected to an InfluxDB instance": "未连接到 InfluxDB 实例",
  "Not connected to an Oracle instance": "未连接到 Oracle 实例",
  "Not found — install it, or type the full path.": "未找到 —— 请安装它，或输入完整路径。",
  "not runtime-writable": "运行时不可写",
  "Office SOCKS": "办公 SOCKS",
  OK: "确定",
  "Open an SSH tab — {label} runs via the remote host's CLI.":
    "打开 SSH 标签页 —— {label} 会通过远程主机的 CLI 运行。",
  "Open an SSH tab to connect to a database.": "请打开 SSH 标签页来连接数据库。",
  "Open remote desktop": "打开远程桌面",
  "Optional — Windows domain": "可选 —— Windows 域",
  "Pack imported": "命令包已导入",
  "Page size in bytes": "页大小（字节）",
  "PostgreSQL settings": "PostgreSQL 设置",
  "Primary key": "主键",
  "Read-only — click to allow writes": "只读 —— 点击允许写入",
  "read-only at runtime": "运行时只读",
  "Rebuild tunnel": "重建隧道",
  "Redis DB index (0-15 by default)": "Redis DB 索引（默认 0-15）",
  Reject: "拒绝",
  "Remove image {id}?": "移除镜像 {id}？",
  "Remove network {name}?": "移除网络 {name}？",
  "Remove volume {name}? Any data stored in the volume will be lost.":
    "移除卷 {name}？卷中存储的任何数据都会丢失。",
  "Replace pin & connect": "替换固定密钥并连接",
  "requires restart ({context})": "需要重启（{context}）",
  Row: "行",
  "Runs {bin} on the SSH host — it must be installed there and able to reach the database.":
    "在 SSH 主机上运行 {bin} —— 该程序必须安装在远程主机上，并且能够访问数据库。",
  "Runs the CLI's --version to confirm it's installed and on PATH.":
    "运行 CLI 的 --version 以确认它已安装并在 PATH 中。",
  "Send Ctrl+C": "发送 Ctrl+C",
  "Service / SID": "服务 / SID",
  Smart: "智能",
  "Smart · alt": "智能 · alt",
  "Smart mode bypassed: alt-screen app (vim / htop / tmux)":
    "智能模式已绕过：alt-screen 应用（vim / htop / tmux）",
  "Smart mode is intercepting Tab / autosuggest in this tab":
    "智能模式正在拦截此标签页中的 Tab / 自动建议",
  soon: "即将推出",
  "SQLite does not support changing column types in place.":
    "SQLite 不支持原地修改列类型。",
  "SQLite pragmas": "SQLite PRAGMA",
  SSH: "SSH",
  "SSH connection required for log streaming.": "需要 SSH 连接才能流式查看日志。",
  "SSH credentials are not ready yet.": "SSH 凭据尚未就绪。",
  "SSH terminal": "SSH 终端",
  "SSH tunnel · 127.0.0.1:{port}": "SSH 隧道 · 127.0.0.1:{port}",
  "SSH tunnel · error": "SSH 隧道 · 错误",
  "SSH tunnel · idle": "SSH 隧道 · 空闲",
  "SSH tunnel · opening…": "SSH 隧道 · 打开中…",
  "Stage changes to commit": "暂存更改以提交",
  "Start native CLI terminal": "启动原生 CLI 终端",
  "Starting native CLI…": "正在启动原生 CLI…",
  "starting…": "启动中…",
  State: "状态",
  "Stop tunnel": "停止隧道",
  "Stream ended.": "流已结束。",
  "Stream exited ({code}).": "流已退出（{code}）。",
  "Sync level on commit (0 / 1 / 2 / 3)": "提交同步级别（0 / 1 / 2 / 3）",
  "Temp store backing (file / memory)": "临时存储位置（file / memory）",
  "Text or hash": "文本或哈希",
  "The pinned key for {host} no longer matches what the server presented. This is what an active man-in-the-middle would look like. Reject unless you know the host key was rotated.":
    "为 {host} 固定的主机密钥与服务器当前提供的不一致。这正是主动中间人攻击会呈现的样子。除非你确认主机密钥已轮换，否则请拒绝。",
  "The tunnel opens automatically when you connect.": "连接时会自动打开隧道。",
  ...
  "This permanently removes the database \"{db}\" and every schema inside it. The connection will close. This cannot be undone.":
    "这会永久删除数据库 \"{db}\" 及其中的所有 schema。连接将关闭。此操作无法撤销。",
  "This permanently removes the database \"{db}\" and every table inside it. This cannot be undone.":
    "这会永久删除数据库 \"{db}\" 及其中的所有表。此操作无法撤销。",
  "This permanently removes:\n  {tables}\n\nAll data and structure are deleted.":
    "这会永久删除：\n  {tables}\n\n所有数据和结构都会被删除。",
  "This tab has no SSH context.": "此标签页没有 SSH 上下文。",
  "Token / Password": "Token / 密码",
  "Truncate {n} table(s)?": "清空 {n} 张表？",
  "Truncate {n} tables…": "清空 {n} 张表…",
  "Truncate…": "清空…",
  "Truncated {n} table(s).": "已清空 {n} 张表。",
  "Trust this host": "信任此主机",
  "Tunnel actions": "隧道操作",
  "Type for the CLI — Enter sends, Shift+Enter adds a line":
    "输入给 CLI —— Enter 发送，Shift+Enter 换行",
  "User-defined schema version": "用户定义的 schema 版本",
  "Verify host fingerprint": "验证主机指纹",
  "Verify sudo / become-user works with this password":
    "验证 sudo / 切换用户是否可使用此密码",
  "Waiting for output…": "等待输出…",
  "Waiting for terminal output…": "等待终端输出…",
  "WAL auto-checkpoint threshold": "WAL 自动检查点阈值",
  "Was {name}": "原为 {name}",
  "When you elevate in the terminal (sudo or su) and type the password, reuse it for the right-side panels (SFTP, DB, Docker…) so they follow your elevation without a second prompt. Kept in memory for this session only — never written to the keychain. The captured value is your own password (sudo) or root's (su); the backend tries sudo then su.":
    "当你在终端中提权（sudo 或 su）并输入密码时，将其复用于右侧面板（SFTP、DB、Docker 等），这样它们可以跟随你的提权状态而无需二次输入。该值只保存在本次会话的内存中 —— 永远不会写入钥匙串。捕获的值可能是你自己的密码（sudo）或 root 密码（su）；后端会先尝试 sudo，再尝试 su。",
  "Writes enabled — click to lock": "已启用写入 —— 点击锁定",
  Yes: "是",

  // Direct JSX/UI text now routed through i18n
  "© 2024–2026 Pier-X · MIT licensed": "© 2024–2026 Pier-X · MIT 许可",
  "Actual rows": "实际行数",
  "Actual time, ms": "实际耗时，ms",
  Buffers: "缓冲区",
  Connected: "已连接",
  DESCRIPTION: "说明",
  Disconnected: "已断开",
  ...
  fps: "fps",
  frames: "帧数",
  "CLI providers use their own account/CLI response limit; this field is ignored.":
    "CLI 服务使用账号或 CLI 自己的回复上限；此字段会被忽略。",
  mode: "模式",
  "Max output tokens per turn": "单轮最大输出 token",
  "No changes — the buffer matches what's on disk.":
    "没有更改 —— 缓冲区与磁盘内容一致。",
  "No documentation found for {command}.": "未找到 {command} 的文档。",
  "No matches": "无匹配项",
  "OPTIONS · {n}": "选项 · {n}",
  "Reads the CLI's local model cache, config and recent history; you can still type any model id or leave it blank for the account default.":
    "读取 CLI 的本地模型缓存、配置和最近历史；你仍然可以输入任意模型 ID，也可以留空使用账号默认值。",
  "0 = backend default ({tokens}). Caps one API response, not the model context window.":
    "0 = 后端默认（{tokens}）。限制单次 API 回复输出，不是模型上下文窗口。",
  resize: "缩放",
  "Resize left sidebar": "调整左侧边栏宽度",
  "Resize right panel": "调整右侧面板宽度",
