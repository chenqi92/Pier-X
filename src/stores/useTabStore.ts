...
function makeDefaultTab(
  ...
  return {
    ...
    pgTlsMode: partial.pgTlsMode ?? "off",
    mssqlHost: partial.mssqlHost ?? "127.0.0.1",
    mssqlPort: partial.mssqlPort ?? 1433,
    mssqlUser: partial.mssqlUser ?? "sa",
    mssqlPassword: partial.mssqlPassword ?? "",
    mssqlDatabase: partial.mssqlDatabase ?? "",
    mssqlTunnelId: partial.mssqlTunnelId ?? null,
    mssqlTunnelPort: partial.mssqlTunnelPort ?? null,
    mssqlTlsMode: partial.mssqlTlsMode ?? "off",
    influxHost: partial.influxHost ?? "127.0.0.1",
    influxPort: partial.influxPort ?? 8086,
    influxUser: partial.influxUser ?? "",
    influxPassword: partial.influxPassword ?? "",
    influxToken: partial.influxToken ?? "",
    influxDatabase: partial.influxDatabase ?? "",
    influxTunnelId: partial.influxTunnelId ?? null,
    influxTunnelPort: partial.influxTunnelPort ?? null,
    oracleHost: partial.oracleHost ?? "127.0.0.1",
    oraclePort: partial.oraclePort ?? 1521,
    oracleUser: partial.oracleUser ?? "system",
    oraclePassword: partial.oraclePassword ?? "",
    oracleService: partial.oracleService ?? "",
    damengHost: partial.damengHost ?? "127.0.0.1",
    damengPort: partial.damengPort ?? 5236,
    damengUser: partial.damengUser ?? "SYSDBA",
    damengPassword: partial.damengPassword ?? "",
    ...
    mssqlActiveCredentialId: partial.mssqlActiveCredentialId ?? null,
    influxActiveCredentialId: partial.influxActiveCredentialId ?? null,
    oracleActiveCredentialId: partial.oracleActiveCredentialId ?? null,
    damengActiveCredentialId: partial.damengActiveCredentialId ?? null,
